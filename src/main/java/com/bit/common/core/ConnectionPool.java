...
public class ConnectionPool {
     ...
     * 默认构造方法
     */
    public ConnectionPool(long minPoolSize, long maxPoolSize, long waitTimes,int connectTimeout,int networkTimeout,String charset,int tracker_http_port,boolean antiStealToken,String secret_key,String tracker_server) {
    ...
    private void poolInit( ) {
        try {
            ...
            LOGGER.error("[FASTDFS初始化(init)--异常]["  + "][异常：{}]", e);
        }
    }
